...
export const mockCreatives: CreativeRow[] = [
  ...
  },
  {
    ...
    cpm: 17.5, conv_rate: 1.51,
    frequency: 2.8, video_3s_rate: null, video_thruplay_rate: null,
  },
  {
    ad_id: "ad3", ad_name: "Imagem Estática | Depoimento 1", campaign_name: "Vendas | Produto B | Conversão", platform: "meta",
    creative_type: "image", headline: null,
    ...
    cpm: 15.0, conv_rate: 1.30,
    frequency: 1.9, video_3s_rate: null, video_thruplay_rate: null,
  },
  {
    ad_id: "ad4", ad_name: "VSL Curta 15s | Retargeting", campaign_name: "Remarketing | Carrinho | Meta", platform: "meta",
    creative_type: "video", headline: "Ainda está pensando? Veja o que aconteceu",
    ...
    cpm: 20.5, conv_rate: 1.20,
    frequency: 3.9, video_3s_rate: 52, video_thruplay_rate: 31,
  },
  {
    ...
    revenue: 3_400, sales: 12, roas: 1.85, cpa: 153.33,
    cpm: 15.33, conv_rate: 0.63,
    frequency: 4.6, video_3s_rate: null, video_thruplay_rate: null,
  },
  {
    ad_id: "ad6", ad_name: "Responsive Search | Comprar", campaign_name: "Sales | Product A | Max Conv", platform: "google",
    creative_type: "image", headline: "Compre agora com desconto exclusivo",
    thumbnail_url: null,
    video_url: null, permalink_url: null,
    impressions: 140_000, clicks: 2_800, ctr: 2.0, spend: 2_050,
    revenue: 9_100, sales: 34, roas: 4.44, cpa: 60.29,
    cpm: 14.64, conv_rate: 1.21,
    frequency: null, video_3s_rate: null, video_thruplay_rate: null,
  },
];
...
export const mockSales: SaleRow[] = [
  { id: "s1",  created_at: "2024-03-15T14:22:00Z", gateway: "dmguru",  sale_type: "main",       amount: 300, status: "approved",   product_name: null,
  ...
  { id: "s2",  created_at: "2024-03-15T14:22:00Z", gateway: "dmguru",  sale_type: "order_bump", amount:  47, status: "approved",   product_name: null,
    utm_medium: "lt-ws-destrave-prosperidade-vendas", utm_campaign: "00-adv-aberto-regras",    utm_content: "ad08-video-criativo-06-lt-prosperidade", utm_source: "Instagram_Feed",    utm_term: "120241143883600607", payment_method: "credit_card" },
  { id: "s3",  created_at: "2024-03-15T13:45:00Z", gateway: "hotmart", sale_type: "main",       amount: 150, status: "approved",   product_name: null,
  ...
  { id: "s4",  created_at: "2024-03-15T12:10:00Z", gateway: "dmguru",  sale_type: "main",       amount: 400, status: "approved",   product_name: null,
  ...
  { id: "s5",  created_at: "2024-03-15T11:30:00Z", gateway: "dmguru",  sale_type: "upsell",     amount: 197, status: "approved",   product_name: null,
    utm_medium: "lt-ws-destrave-prosperidade-vendas", utm_campaign: "01-ret-visitantes-7d",    utm_content: "ad05-video-curto-15s-ret",               utm_source: "Instagram_Stories", utm_term: "120241143883600609", payment_method: "credit_card" },
  { id: "s6",  created_at: "2024-03-15T11:30:00Z", gateway: "dmguru",  sale_type: "main",       amount: 300, status: "refunded",   product_name: null,
  ...
  { id: "s7",  created_at: "2024-03-15T10:55:00Z", gateway: "dmguru",  sale_type: "main",       amount: 320, status: "approved",   product_name: null,
  ...
  { id: "s8",  created_at: "2024-03-14T18:40:00Z", gateway: "dmguru",  sale_type: "main",       amount: 300, status: "approved",   product_name: null,
  ...
  { id: "s9",  created_at: "2024-03-14T18:40:00Z", gateway: "dmguru",  sale_type: "order_bump", amount:  47, status: "approved",   product_name: null,
    utm_medium: "lt-ws-destrave-prosperidade-vendas", utm_campaign: "00-adv-aberto-regras",    utm_content: "ad08-video-criativo-06-lt-prosperidade", utm_source: "Instagram_Feed",    utm_term: "120241143883600607", payment_method: "pix" },
  { id: "s10", created_at: "2024-03-14T17:15:00Z", gateway: "hotmart", sale_type: "main",       amount: 150, status: "approved",   product_name: null,
  ...
  { id: "s11", created_at: "2024-03-14T16:00:00Z", gateway: "dmguru",  sale_type: "main",       amount: 400, status: "chargeback", product_name: null,
    utm_medium: "vendas-produto-b-perpétuo",          utm_campaign: "02-adv-interesse-amplo",  utm_content: "ad11-carrossel-beneficios-02",           utm_source: "Facebook_Feed",     utm_term: "120241143883600610", payment_method: "credit_card" },
  { id: "s12", created_at: "2024-03-14T14:30:00Z", gateway: "dmguru",  sale_type: "main",       amount: 300, status: "approved",   product_name: null,
  ...
  { id: "s13", created_at: "2024-03-14T13:00:00Z", gateway: "dmguru",  sale_type: "main",       amount: 320, status: "approved",   product_name: null,
