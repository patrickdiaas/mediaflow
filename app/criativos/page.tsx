...
import { creatives, Creative } from "@/lib/mock-data";
...
export default function CriativosPage() {
  ...
  const data = creatives[platform][mode];
            ...
            {mode === "lead-gen" ? (
              ...
              <>
                ...
                <div className="bg-card border border-border rounded-xl p-4">
                  ...
                  <p className="font-mono text-lg text-text-primary">{fmtCurrency(totGasto / data.length)}</p>
                </div>
              </>
            )}
          </div>
