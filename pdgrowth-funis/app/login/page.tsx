...
function LoginForm() {
  ...
  return (
    <div className="bg-card border border-border rounded-2xl p-6">
      ...
      <p className="text-xs text-text-muted mb-5">Digite a senha para acessar o painel.</p>
        ...
        <div className="relative">
          <input
            ...
            className={`w-full bg-bg border rounded-lg px-3 py-2.5 text-sm text-text-primary pr-10 focus:outline-none transition-colors ${
              error ? "border-red/50 focus:border-red/70" : "border-border focus:border-accent/40"
            }`}
          />
      ...
      <div className="w-full max-w-sm">
        <div className="flex items-center gap-3 mb-8 justify-center">
          ...
          <div className="leading-tight">
            ...
            <span className="text-text-muted text-[11px] font-mono">{"// funis"}</span>
          </div>
        </div>
